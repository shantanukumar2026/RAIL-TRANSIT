        ...
        <div style={{ display: 'grid', gridTemplateColumns: 'repeat(12, 1fr)', gap: '3.5rem', alignItems: 'center' }}>
          ...
          <div style={{ gridColumn: 'span 6' }}>
            <div className="img-hover-zoom" style={{ border: '1px solid #E5E7EB', background: '#F8F9FA', position: 'relative' }}>
              ...
              />
              <div style={{ position: 'absolute', top: '1rem', left: '1rem', background: '#143D2E', color: '#C5A059', fontSize: '10px', fontWeight: 900, padding: '4px 10px', letterSpacing: '0.12em', textTransform: 'uppercase', border: '1px solid #C5A059', fontFamily: "'Geist', sans-serif !important" }}>
          ...
          <div style={{ gridColumn: 'span 6' }}>
            <div className="eyebrow">
              ...
              <span>PRECISION METALLURGY &amp; MACHINING</span>
            </div>

            <h2 style={{ fontSize: '2.25rem', color: '#143D2E', fontWeight: 900, margin: '0 0 1.25rem 0', lineHeight: 1.15, textTransform: 'uppercase', fontFamily: "'Geist', sans-serif !important" }}>
            ...
            <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '1.5rem' }}>
              <div style={{ borderLeft: '3px solid #C5A059', paddingLeft: '1rem' }}>
                <strong style={{ fontSize: '13px', color: '#143D2E', display: 'block', textTransform: 'uppercase', letterSpacing: '0.04em', fontWeight: 900, fontFamily: "'Geist', sans-serif !important" }}>
